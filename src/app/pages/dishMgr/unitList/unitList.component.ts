...
import { DishMgrService, UnitListParams, EditUnitParams} from '../dishMgr.service';
...
export class UnitListComponent implements OnInit {
  ...
  params: UnitListParams = new UnitListParams();
      ...
      search(reset: boolean = false) {
          ...
          this._loading = true;
          this.service.getUnitList(this.params).subscribe(res => {
              this._loading = false;
              if (res.State == 0) {
